//Creamos una instancio de socket.io del lado del cliente: 
...
//Fire es el método que nos permite configurar el alerta. 
...
chatBox.addEventListener("keyup", (event) => {
    if(event.key === "Enter") {
        ...
        if(chatBox.value.trim().length > 0) {
            //Si el mensaje, despues de que quite los espacios, tiene  mas de 0 caracteres lo enviamos al servidor. 
